...
halo_modelnew=wp.HaloModelInterpolatedFromFile(Filename="../wimprates/data/dataMW1/FourCoefs.txt",
...
plt.title("SI WIMP-nucleon recoil rate, $\\sigma=10^{-45} cm^{-2}$, M=$500 GeV/c^2$")
plt.show()
